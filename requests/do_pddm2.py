...
header = {
    ...
    "Host": "pddm.tydic.com",
    "Origin": "https://pddm.tydic.com",
    "Pragma": "no-cache",
    "Referer": "https://pddm.tydic.com/views/business/project/project_list.html?pri_menu_id=174",
...
def getP(item,dataIn):
    ...
    if response.status_code == 200:
        ...
        if data.get('success') == True:
            ...
            if(tbProducts):
                for p in tbProducts:
                    if p.get('productId')==mainProductId:
                        dataIn['主产品']=p.get('productName')
